...
const WelcomeSection = () => {
  ...
  return (
    <div
      id="welcome"
      className="flex flex-col justify-center items-center text-center w-full bg-gradient-to-br from-[#FF4500] via-[#FF6347] to-[#FFB383] bg-cover bg-center h-auto py-20 px-8"
    ...
    >
      ...
      <button className="flex flex-row gap-3 mt-6 px-8 py-3 bg-white text-[#FF4500] rounded-lg hover:bg-red-300">
