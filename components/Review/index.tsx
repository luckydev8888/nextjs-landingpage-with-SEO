...
const ReviewSection = () => {
  ...
  return (
    <div id="reviews" className="w-full">
      {/* Reviews Section */}
      <div className="flex justify-center bg-gradient-to-br from-[#FF4500] via-[#FF6347] to-[#FFB383] py-16 px-4">
        <motion.div
          initial={{ opacity: 0 }}
        ...
        >
          <div className="flex flex-col lg:flex-row gap-12 items-stretch justify-between w-full mt-8 sm:mt-16">
            ...
            <div className="flex flex-col items-center justify-center w-full lg:w-1/3 text-center">
              <h4 className="text-sm text-black">Real Customers Reviews</h4>
              <h3 className="text-3xl sm:text-4xl mt-3 leading-[48px] font-bold max-w-[300px] text-black">
                What people say
              </h3>
              <p className="text-white text-base sm:text-xl leading-8 mt-3 max-w-[500px]">
